...
import br.com.sebratel.bff.entity.EstoqueView; // A interface acima
...
@Repository
// Importante: JpaRepository precisa de uma @Entity real. 
// Se você não tiver uma @Entity Estoque, use uma que já existe (ex: Person) 
// apenas para satisfazer o generic, ou crie a Entidade abaixo.
public interface EstoqueRepository extends JpaRepository<EstoqueEntity, Long> {
    ...
    @Query(value = """
        ...
        """, nativeQuery = true)
    List<EstoqueView> findEstoqueByTecnicoNative(@Param("nomeTecnico") String nomeTecnico);
}
